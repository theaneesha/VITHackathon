...
@app.route('/details', methods = ['POST', 'GET'], host="vithackathon.herokuapp.com")
def details():
...
@app.route('/symptoms', methods = ['POST', 'GET'], host="vithackathon.herokuapp.com")
def symptoms():
   if request.method == 'POST':
...
@app.route('/result', methods = ['POST', 'GET'], host="vithackathon.herokuapp.com")
def result():
   if request.method == 'POST':
...
@app.route('/suggestion', methods = ['POST', 'GET'], host="vithackathon.herokuapp.com")
def suggestion():
